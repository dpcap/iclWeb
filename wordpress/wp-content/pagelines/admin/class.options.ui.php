		...
		<div id="vpro_billboard" class="vpro-billboard">
			<div class="vpro-billboard-pad">
				...
				<div class="whatsmissing">
					...
					<p>
						The pro version has way more control options. For advanced users, there is also a Developer version that supports "integrations" and WP "multisite"... To learn more see the <a href="http://www.pagelines.com/pricing?ref=le-admin">pricing page</a> or <a href="http://www.pagelines.com/tour?ref=le-admin">PageLines tour</a>...
					</p>
					<p>
